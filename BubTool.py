...
from CPMCY import OfficialCyloTool
...
def banner(console):
    ...
    brand_name =  "Car Parking Multiplayer 1 Tool - t.me/Cylo_plays"
    colors = [
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cpm = OfficialCyloTool(acc_access_key)
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if status == 0:
                    print(Colorate.Horizontal(Colors.rainbow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.rainbow, '======================================'))
                    print(Colorate.Horizontal(Colors.rainbow, f'INFO: In order to tweak this account with CPMcy.'))
